...
async function fetchPosts() {
    ...
    const lis = data.docs.map(book => `
        <div class="post">
            <h2 class="post-title" id="${book.id}">${book.name}</h2>
            <button class="edit" id="${book.id}">Edit Post</button>
            <button class="delete" id="${book.id}">Delete Post</button>
        </div>
    `);
